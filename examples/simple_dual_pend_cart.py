...
dump({'x_dot_str': x_dot_str}, 'examples/simple_dual_pend_cart.str')

x_dot_pl = sp.Matrix([x_dot_pl[2], x_dot_pl[5], x_dot_pl[0], x_dot_pl[3], x_dot_pl[1], x_dot_pl[4]])
x_dot_pl_str = str_replace_all(str(x_dot_pl), replacements)
dump({'x_dot_str': x_dot_pl_str}, 'examples/simple_dual_pend_cart_pl.str')